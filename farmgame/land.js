 ...
 * @param {} gameObj
 */
farmgame.Land = function(gameObj, playerObj) {
    goog.base(this);
...
goog.inherits(farmgame.Land,lime.Sprite);

//states
farmgame.Land.prototype.EMPTY = 0;
farmgame.Land.prototype.PLOWED = 1;
farmgame.Land.prototype.GROWING = 2;
farmgame.Land.prototype.READY = 3;
