//set main namespace
goog.provide('farmgame');
//get requirements
goog.require('lime.Director');
goog.require('lime.Scene');
goog.require('lime.Layer');
goog.require('lime.GlossyButton');
goog.require('farmgame.Land');

//entrypoint
farmgame.start = function(){
    ...
    for(var i=0; i<gameObj.num_tiles_x; i++) {
        for(var j=0; j<gameObj.num_tiles_y; j++) {
            var landElement = new farmgame.Land(gameObj, playerObj).setPosition(i*gameObj.tile_size, j*gameObj.tile_size);
